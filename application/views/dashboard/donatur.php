          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="pelanggan" class="table table-bordered table-striped table-responsive">
                ...
                <tbody>
                <?php $i=1; foreach($donatur as $row): ?>
                    <tr>
                    ...
                    <?php if($role_id == 1): ?>
                      <td class="text-center">
                        <a href="<?= base_url('dashboard/deleteDonatur/').$row['id']; ?>" title="Klik untuk menghapus"><i class="far fa-trash-alt text-danger"></i></a>
                      </td>
                    <?php endif; ?>
                    </tr>
                <?php endforeach;?>
